...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_RATE_DROP_ITEM_LEVEL,
    CONFIG_UINT32_RATE_DROP_ITEM_COUNT_SMALL_ITEM_LEVEL,
    ...
    CONFIG_UINT32_DELETE_OLD_CHARS_KEEP_DAYS,
    CONFIG_UINT32_DELETE_OLD_CHARS_MIN_LEVEL,
    ...
    CONFIG_UINT32_AUTOMUTE_MESSAGE_COUNT,
    CONFIG_UINT32_AUTOMUTE_MESSAGE_DELAY,
    CONFIG_UINT32_AUTOMUTE_MUTE_TIME,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_RATE_DROP_ITEM_COUNT,
    CONFIG_FLOAT_RATE_DROP_ITEM_PERCENT,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_INSTANCE_ENTER_ICC_ACHIEV,
