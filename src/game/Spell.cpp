...
<<<<<<< HEAD
                ...
                case 71341:                                 // Pact of the Darkfallen
                    ...
                    break;
=======
>>>>>>> 90c0c6c83239bbb97e2125e92006756402d98403
        ...
        case TARGET_EFFECT_SELECT:
        {
            ...
            switch(m_spellInfo->Effect[effIndex])
            {
                ...
                case SPELL_EFFECT_SUMMON_PLAYER:
                    if (m_caster->GetTypeId()==TYPEID_PLAYER && ((Player*)m_caster)->GetSelectionGuid() && !(m_caster->GetMapId() == 13))
                    {
...
void Spell::cast(bool skipCheck)
{
    ...
    switch(m_spellInfo->SpellFamilyName)
    {
        case SPELLFAMILY_GENERIC:
        {
            ...
            else if (m_spellInfo->Id == 70192)
                    AddUnitTarget(m_caster, EFFECT_INDEX_1);
